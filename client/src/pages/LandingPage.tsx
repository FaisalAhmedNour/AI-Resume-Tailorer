                            ...
                            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                                <div className="sm:text-center lg:text-left">
                                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                        ...
                                        <span className="block text-blue-600 xl:inline">AI-tailored resumes</span>
                                    </h1>
                                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                        Optimize your resume for every job application instantly. Our AI analyzes the job description and rewrites your resume to highlight relevant skills and experience.
                                    </p>
                            ...
                            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                                <div className="relative">
                                    <dt>
                                        ...
                                        <p className="ml-16 text-lg leading-6 font-medium text-gray-900">AI-Powered Optimization</p>
                                    </dt>
                                    <dd className="mt-2 ml-16 text-base text-gray-500">
                                        Advanced AI algorithms analyze job requirements and align your resume perfectly.
                                    </dd>
                                </div>
                                ...
                                <div className="relative">
                                    <dt>
                                        ...
                                        <p className="ml-16 text-lg leading-6 font-medium text-gray-900">ATS Friendly</p>
                                    </dt>
                                    <dd className="mt-2 ml-16 text-base text-gray-500">
